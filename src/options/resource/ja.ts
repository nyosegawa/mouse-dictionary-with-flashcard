...
const JapaneseTextResource: TextResource = {
  ...
  totalCards: "総カード数",
  dueCards: "今日の復習カード",
  cardsReviewedToday: "今日復習したカード",
  noCardsToReview: "今日復習するカードはありません。お疲れ様でした！",
  ...
  easy: "簡単",
  settings: "設定",
  allFlashcards: "全フラッシュカード一覧",
  word: "単語",
  translation: "訳",
  nextReviewDate: "次回学習日",
  actions: "操作",
  edit: "編集",
  save: "保存",
  delete: "削除",
  reviewNow: "今すぐ復習",
  confirmDeleteCard: "このカードを削除してもよろしいですか？",
  cardReset: "このカードを本日復習できるようにしました。",
  review: "復習",
  cardList: "カード一覧",
